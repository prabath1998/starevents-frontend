  ...
  const kpiMetrics = kpi
    ? [
        ...
        },
        {
          ...
          icon: DollarSign,
          subtext: `+${
            kpi.revenueCentsLast30Days
              ? kpi.revenueCentsLast30Days.toFixed(2)
              : 0
          } this month`,
        },
        {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          ...
          kpiMetrics.map((item, index) => (
            <Card
              key={index}
              className="bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 p-6 flex items-start space-x-4 transition-transform duration-300 hover:scale-[1.02] shadow-xl hover:shadow-2xl"
            >
              ...
              <div className="flex-grow">
                ...
                <div className="mt-1 text-4xl font-bold text-indigo-300">
                  {item.value}
                </div>
