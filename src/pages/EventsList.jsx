  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 text-center">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-white mb-2">Upcoming Events</h1>
        <p className="text-gray-400 mb-6">Explore a variety of events happening near you.</p>
